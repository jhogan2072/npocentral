  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved auction as @auction" do
        ...
        post :create, {:auction => { "name" => "invalid value" }}, valid_session
        assigns(:auction).should be_a_new(Auction)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested auction" do
        ...
        Auction.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => auction.to_param, :auction => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the auction as @auction" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Auction.any_instance.stub(:save).and_return(false)
        put :update, {:id => auction.to_param, :auction => { "name" => "invalid value" }}, valid_session
        assigns(:auction).should eq(auction)
      end
